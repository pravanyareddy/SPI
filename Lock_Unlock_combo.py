...
#    print'INSIDE PANEL 1'

            

    while continue_reading:
        
#        print'INSIDE PANEL 2'

        (status,TagType) = MIFAREReader.MFRC522_Request(MIFAREReader.PICC_REQIDL)

#        print'INSIDE PANEL 3'
#        print status
...
#            print'INSIDE PANEL 4'
        ...
        if status == MIFAREReader.MI_OK:
            ...
            global parentRootJSONObject
            responseReceived=requests.post(customURL)
            parentRootJSONObject = responseReceived.json()
            print parentRootJSONObject,"print inside name"
            Condition_card()
