...
def Rasp_Card():
    ...
    global  continue_reading
    global flag
    cycle_list=("1344723848", "8620524048", "21414324948", "86924748", "198424648", "3816924448")
    ...
    while continue_reading:                
	    ...
	    if (tot_uid in cycle_list):
                print ("Approved")
                lcd_string(" Cycle got Locked   ",LCD_LINE_1,2)
                lcd_string(" THANK  YOU         ",LCD_LINE_2,2)
		lcd_string(" Hope You Had a     ",LCD_LINE_3,2)
                lcd_string("  Great Ride!!...   ",LCD_LINE_4,2)
	        time.sleep(2)
	        main1()
#	    else:
...
def Condition_card():
	    PINNum=''
            ...
            approved_list1=("42416216228")
            approved_list2=("185163241100143")
            approved_list3=("153121243100119") 
            approved_list4=("153217232100204")
            approved_list5=("4815116257")
            approved_list6=("194866038142")
